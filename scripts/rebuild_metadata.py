...
# Disable PostHog telemetry to prevent ChromaDB capture() errors
...
def main():
    ...
    eval_pairs_file = "data/processed/eval_pairs.jsonl"
    if os.path.exists(eval_pairs_file):
        os.remove(eval_pairs_file)
